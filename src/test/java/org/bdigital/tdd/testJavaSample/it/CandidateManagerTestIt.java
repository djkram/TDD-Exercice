 ...
 *
 */
public class CandidateManagerTestIt extends TestCase {
	...
	public void testExecuteTheCandidatesProcesJohn() throws Exception{
		...
		Candidate  candidate2= new Candidate("John", 40, 15, 30000);
		Candidate  candidate3= new Candidate("Juan", 40, 11, 31000);
		
		when(internetConnector.getCanidate())
		...
		Candidate candidate = candidateManager.getBestCandidate(3);
